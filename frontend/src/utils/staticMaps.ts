...
export function staticMapUrl(options: {
  ...
  let url =
    ...
    `&style=element:labels.text.stroke${P}color:0x242f3e` +
    `&style=feature:road${P}element:geometry${P}color:0x38414e` +
    `&style=feature:road${P}element:labels${P}visibility:off` +
    `&style=feature:road.highway${P}element:geometry${P}color:0x746855` +
    `&style=feature:poi${P}element:labels${P}visibility:off` +
    `&style=feature:transit${P}element:labels${P}visibility:off` +
    `&style=feature:administrative.neighborhood${P}element:labels${P}visibility:off` +
    `&style=feature:administrative.land_parcel${P}element:labels${P}visibility:off` +
    `&style=feature:water${P}element:geometry${P}color:0x17263c` +
    `&style=feature:water${P}element:labels${P}visibility:off`;
