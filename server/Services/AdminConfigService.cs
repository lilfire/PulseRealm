...
public class AdminConfigService
{
    ...
    /// <summary>
    /// Atomically increments the popularity count for a curated item key and persists to disk.
    /// </summary>
    public void IncrementPopularity(string key)
    {
        lock (_lock)
        {
            _config.PopularityCounts.TryGetValue(key, out var count);
            _config.PopularityCounts[key] = count + 1;
            Save(_config);
        }
    }
